...
if ($user['greutate'] > 0 && $user['inaltime'] > 0) {
    ...
    if ($imc < 18.5) { 
        $imc_msg = "IMC: $imc_format (Subponderal)"; $imc_color = "#f0ad4e"; 
    } elseif ($imc >= 18.5 && $imc < 25) { 
        $imc_msg = "IMC: $imc_format (Greutate Normală)"; $imc_color = "#28a745"; 
    } elseif ($imc >= 25 && $imc < 30) { 
        $imc_msg = "IMC: $imc_format (Supraponderal)"; $imc_color = "#ffc107"; 
    } else { 
        $imc_msg = "IMC: $imc_format (Obezitate)"; $imc_color = "#dc3545"; 
    }
}
?>
